...
import { COMMUNITY_AMA, DEVNOTE_6, DEVNOTE_7, LAUNCH_UPDATE, OFFICIAL_SITE, STEAM, STEAM_NEWS } from "./sources";
...
const weaponSections: GuideSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "The six launch classes each arrive with a confirmed set of weapon families. Blackarrow and Sorcerer each have a second weapon in a different official status, so those entries are labeled separately rather than guessed.",
    ],
    subsections: [
      {
      ...
      },
      {
        ...
        paragraphs: ["Confirmed weapon: Bow. The Archer and Hunter playstyle branches are part of the launch kit. Bellring Games has officially confirmed that a second weapon will arrive in a future season, but its name and specific release date have not been announced."],
      },
      {
        heading: "Sorcerer weapons",
        paragraphs: ["Confirmed weapon: Staff. Elemental and Stardust are the launch archetypes within the Staff kit rather than separate weapons. Bellring Games has officially confirmed that a second weapon is in development, but its final name and release timing have not been confirmed."],
      },
      {
  ...
  },
  {
    ...
    paragraphs: [
      "Blackarrow's second weapon is officially confirmed to arrive in a future season, with its name and specific release date not yet announced. Sorcerer's second weapon is officially confirmed to be in development, with its final name and release timing not yet confirmed. Withered Knight's Polearm & Shield is the confirmed launch addition in that class.",
...
const weapons: GuidePageData = {
  ...
  answer: "Every class launches with a confirmed set of weapon families and official playstyle branches. Weapon choice is tied to your skill direction, and you can switch weapons or routes during a fight. Holy weapons, Affix Gems, and loadout share codes complete the system; Blackarrow's second weapon is confirmed for a future season and Sorcerer's second weapon is confirmed to be in development, but neither name nor release timing has been announced.",
  updated: checked,
  published: checked,
  ...
  sources: [OFFICIAL_SITE, DEVNOTE_6, DEVNOTE_7, COMMUNITY_AMA, LAUNCH_UPDATE, STEAM, STEAM_NEWS],
};
